	...
	public function load_custom_wp_admin_style() {
		...
		if ( 'upload.php' == $pagenow ) {
			...
			if ( 'trash' == get_query_var( 'attachment-filter' ) ) {
				$button = '<a href="' . admin_url( 'upload.php' ) . '" class="page-title-action">' . __( 'All media items', 'media-trash-button' ) . '</a>';
			} else {
				$button = '<a href="' . admin_url( 'upload.php?mode=list&attachment-filter=trash' ) . '" class="page-title-action">' . __( 'View Trash', 'media-trash-button' ) . '</a>';
			}
