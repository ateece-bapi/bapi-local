...
class Alg_WC_Call_For_Price_Settings_Per_Product {
	 ...
	 * @since   3.1.1
	 */
	function add_call_for_price_meta_box() {
		add_meta_box(
	...
	function get_meta_box_options() {
		return array(
			...
			array(
				...
				'name'     => 'alg_wc_call_for_price_text' . '_' . 'all_views',
				'type'     => 'textarea',
	 ...
	 * @since   3.1.1
	 */
	function create_call_for_price_meta_box( $post ) {
	 ...
	 * @since   3.1.1
	 */
	function save_call_for_price_meta_box( $post_id ) {
