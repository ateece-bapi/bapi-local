...
class Alg_WC_Call_For_Price {
	...
	function __construct() {
		if ( 'yes' === get_option( 'alg_wc_call_for_price_enabled', 'yes' ) ) {
			...
			if ( 'yes' === ( $do_hide = get_option( 'alg_wc_call_for_price_hide_main_variable_price', 'no' ) ) ) {
	 ...
	 * @since   3.2.3
	 */
	function hide_main_variable_price_on_single_product_page( $price_html ) {
	 ...
	 * @since   3.2.3
	 */
	function hide_main_variable_price_on_single_product_page_with_css() {
