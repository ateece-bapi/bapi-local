<?php
/**
 * License Activation page on activate of the plugin
 */
?>
<form method="post">
    <div class="wrap about-wrap">
        ...
        <div>
            ...
            <p>
                ...
                <input type='hidden' id='wc_call_for_price_license_display' name='wc_call_for_price_license_display' value='2' />
                <input type='hidden' id='edd_license_wc_call_for_price_hidden_button' name='edd_license_wc_call_for_price_hidden_button' value="<?php _e( 'Activate License' ); ?>" />
            ...
            <p style='font-size:14pt;'>
                <input type='checkbox' value='1' id='wc_call_for_price_accept_terms' name='wc_call_for_price_accept_terms' /><?php _e( 'I understand the risks', $plugin_context ); ?>
